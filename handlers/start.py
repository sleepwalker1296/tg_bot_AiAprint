...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_text = (
        ...
        "🚗 *Добро пожаловать в AiAprint* — футболки с вашим авто в стиле авто-аппарель!\n\n"
        "📸 *Как это работает:*\n"
        "1. Отправьте фото вашего автомобиля\n"
        "2. Выберите цвет футболки (белая или чёрная)\n"
        "3. Укажите гос. номер — или пропустите\n"
        "4. ИИ нарисует принт и смешной слоган под вашу машину\n"
        "5. Получите превью и оформите заказ!\n\n"
        "💡 *Просто отправьте фото авто — и поехали!*"
    )
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    help_text = (
        ...
        "📸 *Отправка фото:* Пришлите фото авто → выберите белую или чёрную футболку → "
        "введите гос. номер (или пропустите) → ИИ нарисует принт с юмористическим слоганом под вашу машину.\n\n"
