...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_text = (
        ...
        "🚗 *Добро пожаловать в AiAprint* — принты с вашим авто на футболке!\n\n"
        "📸 *Как это работает:*\n"
        "1. Отправьте фото вашего автомобиля\n"
        "2. Выберите цвет футболки (белая или чёрная)\n"
        "3. Введите текст для принта — или пропустите\n"
        "4. Укажите гос. номер — или пропустите\n"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    help_text = (
        ...
        "📸 *Отправка фото:* Пришлите фото авто → выберите цвет → "
        "введите текст для принта (или пропустите) → введите гос. номер (или пропустите) → "
        "ИИ создаст принт в формате А3.\n\n"
